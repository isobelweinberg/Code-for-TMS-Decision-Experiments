%% Moving RDK - 0% coherence
  try
    ...
    LeftProbabilityArray=[10 100]; %probability the RDK goes left, as a percentage
    TrialsPerBlock=5; 
...
%% Collect the results
   ...
   BlockNo = floor(PositionInBlock); %this used at top of trial loop to set Probability for the block
