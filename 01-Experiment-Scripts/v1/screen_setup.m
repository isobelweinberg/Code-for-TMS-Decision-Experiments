...
%Open a window
screen.windowNo = Screen('OpenWindow', 0, param.BackgroundColour);%0 is the main
Screen('BlendFunction', param.windowNo, 'GL_SRC_ALPHA', 'GL_ONE_MINUS_SRC_ALPHA' ); %anti-aliasing
screen.RefreshRate = Screen('FrameRate', param.windowNo); %in Hz; PTB asks the screen what its refresh rate is
