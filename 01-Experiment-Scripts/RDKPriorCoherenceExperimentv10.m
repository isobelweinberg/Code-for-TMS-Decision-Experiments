%% Moving RDK - 0% coherence
  try
    ...
    NumDots=150;
    CoherenceArray=[0 20 100];%array of coherences you want to use, as a percentage
    LeftProbabilityArray=[100 0]; %probability the RDK goes left, as a percentage
    TrialsPerBlock=5; 
 ...
 %% Present the Stimuli
   ...
   %Loop RDK calculation and presentation by no of trials
    ...
    % assign coherent dots and their directions
     ...
     elseif%MAKE SURE SOMETHING HAPPENS IF THEY ARE GOING RIGHT. THEN CHECK TRIALS AND BLOCK STRUCTURE.
     end
