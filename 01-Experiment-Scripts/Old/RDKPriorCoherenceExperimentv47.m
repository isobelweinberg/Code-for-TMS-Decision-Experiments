try
    ...
    participant.threshold = 0.05; %as a decimal
    ...
    CoherenceArray = [0.5, 1, 1.5]; %proportion of participant's threshold, or just percentages (if you haven't given a threshold)
    ...
    if option.estimatethreshold == 1 && exist('alreadythresholded', 'var') == 0
        filename = strcat(date,'_',participant.Name,'_',time,'_threshold',note);
        ...
        threshold71 = mean(average_coherence);
